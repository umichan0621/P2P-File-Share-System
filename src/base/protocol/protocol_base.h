...
enum PROTOCOL_BASE
{
	...
	PROTOCOL_BASE_CONNECT_REQ,					//主动连接其他公开Tracker
	PROTOCOL_BASE_CONNECT_ACK,
	PROTOCOL_BASE_CONNECT_RFS,
	PROTOCOL_BASE_CONNECT_HELP_REQ,				//请求中间节点协助建立连接
	PROTOCOL_BASE_CONNECT_HELP_ACK,
	PROTOCOL_BASE_CONNECT_HELP_RFS,
	...
	PROTOCOL_BASE_PING_HELP,					//让一个节点去Ping另一个节点，以便两者可以建立连接			
